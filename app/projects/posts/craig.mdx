...
<div style={{ textAlign: 'center', maxWidth: '400px', flex: '1 1 auto' }}>
<img
      src="/images/craig/SCD_algebraic_notation.svg"
      alt="SVG, Chessboard and chess pieces"
      style={{ width: '100%', height: 'auto'}}
    />
<div style={{ fontSize: '10px' }}>
<a href="https://commons.wikimedia.org/wiki/File:SCD_algebraic_notation.svg">Chess_board_blank.svg: *AAA_SVG_Chessboard_and_chess_pieces_04.svg: ILA-boySCD_algebraic_notation.png: Klinderivative work: BeaoSCD_algebraic_notation.png: Klinderivative work: Beao</a>, <a href="https://creativecommons.org/licenses/by-sa/3.0">CC BY-SA 3.0</a>, via Wikimedia Commons
</div>
</div>
...
[![Bryce Chess](https://upload.wikimedia.org/wikipedia/commons/0/00/Bryce_Chess.jpg?20070511113531)](https://commons.wikimedia.org/wiki/File:Bryce_Chess.jpg)
...
[![Infinite chess board](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Infinite_chess_board.jpg/512px-Infinite_chess_board.jpg?20221014031314)](https://commons.wikimedia.org/wiki/File:Infinite_chess_board.jpg)
