...
while the first thing you may think of is a char-array of length 64 for each piece and square
...
This allows us to greatly reduce the number of cycles needed for move generation and analysis
...
this is done for the King, Pawn, and Knight by mapping each square to legal moves from that square and
...
- **Opening and Endgame book support** This would be a relatively simple thing to add. It would allow
