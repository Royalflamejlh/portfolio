...
This project's goal started by just looking around to see what type of guitar pedal would be easily reasonable to build, but still pose some challenges. 
...
As of right now the first prototype of the pedal has been tested and we found some pretty big grounding problems, along with instability in the power supply circuitry.
