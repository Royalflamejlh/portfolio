...
This was my ECE 385 Final project in which I created a full chess game that could be run completely on the DE-10 Lite FPGA.
...
I also hope that I can get some photos / videos of it running, along with moving more of the functionality of the game into hardware.
